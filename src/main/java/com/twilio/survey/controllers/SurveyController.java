...
public class SurveyController {
     ...
     */
    @RequestMapping(value = "/survey/call", method = RequestMethod.POST)
     ...
     * Helloo, Welcome to the " + survey.getTitle() + " survey. This survey is related to your doctors appointment today! Please answer the following questions,With one being the lowest and five being the highest, Please press the key on your keypad.
     */
    private String getFirstQuestionRedirect(Survey survey, HttpServletRequest request) throws Exception {
        String welcomeMessage ="Helloo, Welcome to the " + survey.getTitle() + "survey. This survey is related to your doctors appointment today! Please answer the following questions,With one being the lowest and five being the highest, Please press the key on your keypad.";
;
